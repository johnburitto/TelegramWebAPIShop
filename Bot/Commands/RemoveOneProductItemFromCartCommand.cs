...
{
    public class RemoveOneProductItemFromCartCommand : Command
    {
        protected override List<string> Names { get; set; } = new() { "remove_one_from_cart" };
        ...
        public override async Task Execute(ITelegramBotClient client, CallbackQuery callbackQuery)
        {
            ...
            await RequestClient.Client.DeleteAsync($"api/Cart/{callbackQuery.From.Id}/{id}/{false}");
